...
batch "vda_hosted" do
  code <<-EOH
  c:\\xa_xd_7_5\\x64\\XenDesktopSetup\\XenDesktopVdaSetup.exe /quiet /controllers "CitrixXDDC01.CitrixReady.Cloud" /enable_hdx_ports /optimize /masterimage /enable_remote_assistance
  EOH
